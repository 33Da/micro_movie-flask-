...
def upgrade():
    ...
    op.create_index(op.f('ix_auto_addtime'), 'auto', ['addtime'], unique=False)
    ...
    op.create_index(op.f('ix_movicecol_addtime'), 'movicecol', ['addtime'], unique=False)
    op.create_table('oplog',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('admin_id', sa.Integer(), nullable=True),
    sa.Column('ip', sa.String(length=100), nullable=True),
    sa.Column('reson', sa.String(length=600), nullable=True),
    sa.Column('addtime', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['admin_id'], ['admin.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('oplog')
    op.drop_index(op.f('ix_movicecol_addtime'), table_name='movicecol')
    op.drop_table('movicecol')
    ...
    op.drop_index(op.f('ix_auto_addtime'), table_name='auto')
    op.drop_table('auto')
    # ### end Alembic commands ###
